...
MpcStartTurning::compute_desired_trajectory()
{
  ...
  switch (mode) {
    ...
    case 5: // Mode 4: Wait for some seconds
    {
      qJ_cmd = Eigen::Matrix<double, 12, 1>(
        this->joint_trajectory_[0][0][0], this->joint_trajectory_[mode][1][0],
        this->joint_trajectory_[0][2][0], this->joint_trajectory_[mode][3][0],
        this->joint_trajectory_[0][4][0], this->joint_trajectory_[mode][5][0],
        this->joint_trajectory_[0][6][0], this->joint_trajectory_[mode][7][0],
        this->joint_trajectory_[0][8][0], this->joint_trajectory_[mode][9][0],
        this->joint_trajectory_[0][10][0], this->joint_trajectory_[mode][11][0]
      );
      dqJ_cmd = Vector12d::Zero();
      break;
    }
