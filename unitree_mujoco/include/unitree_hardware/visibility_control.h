...
#define UNITREE_MUJOCO_PUBLIC UNITREE_HARDWARE_EXPORT
#else
#define UNITREE_MUJOCO_PUBLIC UNITREE_HARDWARE_IMPORT
#endif
#define UNITREE_MUJOCO_PUBLIC_TYPE UNITREE_MUJOCO_PUBLIC
...
#if __GNUC__ >= 4
#define UNITREE_MUJOCO_PUBLIC __attribute__((visibility("default")))
#define UNITREE_HARDWARE_LOCAL __attribute__((visibility("hidden")))
#else
#define UNITREE_MUJOCO_PUBLIC
#define UNITREE_HARDWARE_LOCAL
#endif
#define UNITREE_MUJOCO_PUBLIC_TYPE
#endif
